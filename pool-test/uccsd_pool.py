...
def uccsd_get_excitation_list(n_electrons:int, spin:int, n_qubits:int):
    ...
    if spin>0:
        n_occupied_beta=(n_electrons-spin)//2
...
def get_pool_operators(nelectrons, spin, n_qubits):

    singles_alpha, singles_beta, doubles_mixed, doubles_alpha, doubles_beta = \
        uccsd_get_excitation_list(nelectrons, spin, n_qubits)
